...
zee.sendMessage(from, '*Pertanyaan :* '+apakah+'\n*Jawaban :* '+ kah, text, { quoted: mek })
break
...
case 'simplemenu': case 'menusimple': case 'simpelmenu': case 'menusimpel': case'simple': case 'simpel':
          ...
          var lordpebri = zee.prepareMessageFromContent(from, {
						...
						"description": "\n*Kamu bisa pilih menu dengan ketik menu yang ada di bawah*\n\n*LIST MENU*\n❋ཻུ۪۪⸙ .simpel\n❋ཻུ۪۪⸙ .menuowner\n❋ཻུ۪۪⸙ .allmenu\n❋ཻུ۪۪⸙ .menugame\n❋ཻུ۪۪⸙ .menufun\n❋ཻུ۪۪⸙ .rpgmenu\n❋ཻུ۪۪⸙ .menugrup\n❋ཻུ۪۪⸙ .menuanime\n❋ཻུ۪۪⸙ .menudownload\n❋ཻུ۪۪⸙ .menusearch\n❋ཻུ۪۪⸙ .menunulis\n❋ཻུ۪۪⸙ .menuconvert\n❋ཻུ۪۪⸙ .menustorage\n❋ཻུ۪۪⸙ .menuupswbot\n❋ཻུ۪۪⸙ .menusticker\n❋ཻུ۪۪⸙ .menurandomapi\n❋ཻུ۪۪⸙ .menutools\n❋ཻུ۪۪⸙ .menustore",
						"buttonText": "MENU",
...
var media = await zee.downloadMediaMessage(enmedia)
var njay = await uploadImages(media)
var resu = await getBuffer(`https://api.memegen.link/images/custom/-/${teks2}.png?background=${njay}`)
zee.sendMessage(from, resu, image, {caption:'Nih Kak Tinggal Jadikan Sticker', quoted: mek})
fs.unlinkSync(media)
} catch (e) {
console.log(e)
}
...
response = await zee.groupAdd(from, [orang])
o = response.participants[0]
let inv = (Object.values(o))
if(inv[0].code == 409) return reply('Orang yang anda add sudah ada didalam Group!')
else if(inv[0].code == 403){
zee.sendMessage(from, `User private\n\nMengirim Undangan Group Ke @${q.split('@')[0]}`, MessageType.text, {quoted: mek, contextInfo: {mentionedJid: [orang]}})
zee.sendGroupV4Invite(from, orang, inv[0].invite_code, inv[0].invite_code_exp, groupMetadata.subject , `Salah Satu Admin Mengundang Anda Masuk Ke Sini Silahkan Klik Bergabung Untuk Masuk`)
}
					break 
...
vcard3 = 'BEGIN:VCARD\n' +
            ...
            'END:VCARD'.trim()
zee.sendMessage(from, {displayName: `Creator Danzz`, vcard: vcard3}, contact, 
{ quoted: troli, 
})
break
